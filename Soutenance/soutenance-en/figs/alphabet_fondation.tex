                \begin{tikzpicture}[xscale=1.0, yscale=1.0]
                    ...
                    % ---------------- row 1: language ----------------
                    \node[dom] at (1.35, 2.75) {\textbf{language}};
                    \node[jeton, anchor=west] (t1) at (1.75, 2.75) {Graph};
                    ...
                    \node[anchor=west] at ($(m1.east)+(0.14,0)$) {\citb{brown20}};
                    ...
                    \end{scope}
                    \node[font=\scriptsize, text=inria-2024-bleu-canard, anchor=west] at (4.25, 1.45) {patches};
                    \node[modele, anchor=west] (m2) at (9.85, 1.45) {SAM};
                    \node[anchor=west] at ($(m2.east)+(0.14,0)$) {\citb{kirillov23}};
                    \draw[fl] (8.55, 1.45) -- (m2.west);

                    % ---------------- row 3: 3D ----------------
                    \node[dom] at (1.35, 0.05) {\textbf{3D world}};
                    ...
                    \end{scope}
                    \node[font=\scriptsize, text=inria-2024-bleu-canard, anchor=west] at (4.25, 0.05) {sensor returns};
                    ...
                    \node[font=\scriptsize, align=center, text=inria-rouge, anchor=north] at (5.4, -1.05)
                        {in 3D, the unit of computation is still the \textbf{sampling} unit:\\
                         sensor return or grid cell};
                \end{tikzpicture}
