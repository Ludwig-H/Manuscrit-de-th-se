                    % Hierarchy of K-polyhedra, proposed as the unit of computation in place of the point.
                    % The six leaf pieces are the six sectors of one and the same irregular master
                    % polygon (cut into a fan around an interior point O). They are drawn everywhere
                    % at the same scale and in the same orientation: the polyhedron of an internal node
                    % is therefore literally the gluing of those of its two children, welded along the
                    % facet drawn in thick red. The vertical axis is the physical radius r; the red dot
                    % of a node sits at O, at the heart of the polyhedron.
                    ...
                    \node[rotate=90, font=\scriptsize, text=gris_fonce_inria, anchor=south] at (-1.50,2.88) {radius (m)};

                    % ==== tree (drawn behind the polyhedra) ====
                    ...
                    % ==== polyhedra: one per node, at its height ====
                    % node p1
                    ...
                    % ==== nodes: the merge point, at the centre of the polyhedron ====
