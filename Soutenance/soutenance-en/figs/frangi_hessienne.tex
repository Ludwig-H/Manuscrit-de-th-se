% The Hessian ellipse at a pixel of a dark ridge.
% Axes along the eigenvectors e_1, e_2; semi-axes 1/sqrt(|lambda_k|).
% Ridge: |lambda_1| small (major axis, along the crack, angle theta),
% lambda_2 > 0 large (minor axis, across it).
% The bounding box is kept tight: the figure is rendered through a \resizebox.
    \begin{tikzpicture}[x=1cm,y=1cm,scale=1.0,every node/.style={scale=1.0},
      ...
      \begin{scope}[rotate=27]
        ...
        % arrow lengths corrected for the tip: the tips land at 1.75 and 0.62
      ...
      % reference axis and angle theta, drawn outside the ellipse
