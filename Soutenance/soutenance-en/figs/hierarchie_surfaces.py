...
wi(r"% physical radius r ; a node's red dot sits at O, at the centre of the polyhedron.")
...
wi(r"\node[rotate=90, font=\scriptsize, text=gris_fonce_inria, anchor=south] at (-1.50,%s) {radius (m)};"%f(yy(1.2)))
wi()
