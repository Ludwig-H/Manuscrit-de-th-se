                % The same near-flat triangle, seen through its two balls.
                % On the left the circumball: its radius is not bounded by the
                % simplex and its centre goes to infinity as the triangle flattens.
                % On the right the miniball: always defined, centre in conv(sigma),
                % radius bounded by Jung. This is what gives locality.
