                \begin{tikzpicture}[xscale=1.0, yscale=1.0]
                    ...
                    \begin{scope}[xshift=0.4cm, yshift=0.35cm]
                        ...
                        \voiture
                        % Scan lines every 0.108: one runs along the bonnet and the boot
                        % (0.44), another along the roof (0.98); each return lies at the
                        % intersection of a scan line and the outline (step 0.108 along a scan line).
                        ...
                        \node[font=\small, text=gris_fonce_inria, anchor=north] at (1.5,-0.44) {\textbf{nearby} object};
                    \end{scope}

                    % ================== Right panel: far away =====================
                    \begin{scope}[xshift=6.9cm, yshift=0.35cm]
                        \node[cadre, minimum width=5.0cm, minimum height=2.30cm] at (1.5,0.60) {};
                        \voiture
                        % Scan lines 2.5 times further apart (0.27) and returns 3 times further
                        % apart along a scan line (0.34): nine returns on three scan lines.
                        ...
                        \node[font=\small, text=gris_fonce_inria, anchor=north] at (1.5,-0.44) {\textbf{distant} object};
                    \end{scope}
                    ...
                    % left: fine; right: coarse, but the same target
                    ...
                    \begin{scope}[xshift=6.9cm, yshift=-2.40cm]
                        \draw[gray!45, line width=0.7pt, densely dotted] plot coordinates {\contour};
                        % The surface interpolates the nine observed returns: its vertices lie
                        % on the grey outline, the chords cut the corners. Coarse, but it is
                        % indeed the same object, which is the whole point of the slide.
                    ...
                    \node[font=\scriptsize, text=inria-2024-bleu-canard, anchor=east, align=right] at (12.45,0.95)
                        {the \textbf{point cloud}\\depends on sensor\\and range};
                    \node[font=\scriptsize, text=inria-rouge, anchor=east, align=right] at (12.45,-1.90)
                        {the \textbf{surface}\\would vary much less:\\our \emph{hypothesis}};
                \end{tikzpicture}
