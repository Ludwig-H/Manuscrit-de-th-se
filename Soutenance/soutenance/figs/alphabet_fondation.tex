                \begin{tikzpicture}[xscale=1.0, yscale=1.0]
                    \useasboundingbox (-0.35, -1.65) rectangle (12.6, 3.35);
                    ...
                    \node[font=\scriptsize, align=center, text=inria-rouge, anchor=north] at (6.2, -0.80)
                        {l'unité de calcul de la 3D est \textbf{un artefact du capteur},\\
                         pas une unité du monde};
                \end{tikzpicture}
