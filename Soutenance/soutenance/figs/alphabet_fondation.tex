                \begin{tikzpicture}[xscale=1.0, yscale=1.0]
                    ...
                    \node[font=\scriptsize, text=inria-rouge, anchor=north, align=center] at (10.62, -0.30)
                    ...
                    \node[font=\scriptsize, align=center, text=inria-rouge, anchor=north] at (5.4, -1.05)
                        {en 3D, l'unité de calcul reste \textbf{celle du capteur} ---\\
                         c'est le constat dont je pars};
                \end{tikzpicture}
