                \begin{tikzpicture}[xscale=1.0, yscale=1.0]
                    \useasboundingbox (-1.35, -1.15) rectangle (11.75, 4.95);
                    ...
                    \node[font=\scriptsize, text=gris_fonce_inria, anchor=north, align=center] at (4.85,-0.20)
                        {\textbf{chaque} nœud porte une surface observée, pas seulement les feuilles\\
                         {\tiny les feuilles ne sont pas des singletons et naissent à des hauteurs différentes : ce n'est pas un dendrogramme classique}};
                \end{tikzpicture}
