                    ...
                    % Coordonnees engendrees par figs/hierarchie_surfaces.py :
                    % editer le script puis le relancer, pas le TikZ a la main.
                    \begin{tikzpicture}[xscale=1.0, yscale=1.0]
                    \useasboundingbox (-2.15, -0.40) rectangle (10.303, 7.541);
                    ...
                    \node[font=\scriptsize, text=gris_fonce_inria, anchor=east] at (-1.08,0.6) {$0,25$};
                    \draw[gris_fonce_inria, line width=0.6pt] (-1.00,1.2) -- (-0.84,1.2);
                    \node[font=\scriptsize, text=gris_fonce_inria, anchor=east] at (-1.08,1.2) {$0,5$};
                    \draw[gris_fonce_inria, line width=0.6pt] (-1.00,2.4) -- (-0.84,2.4);
                    \node[font=\scriptsize, text=gris_fonce_inria, anchor=east] at (-1.08,2.4) {$1,0$};
                    \draw[gris_fonce_inria, line width=0.6pt] (-1.00,3.6) -- (-0.84,3.6);
                    \node[font=\scriptsize, text=gris_fonce_inria, anchor=east] at (-1.08,3.6) {$1,5$};
                    \draw[gris_fonce_inria, line width=0.6pt] (-1.00,4.8) -- (-0.84,4.8);
                    \node[font=\scriptsize, text=gris_fonce_inria, anchor=east] at (-1.08,4.8) {$2,0$};
                    \draw[gris_fonce_inria, line width=0.6pt] (-1.00,6) -- (-0.84,6);
                    \node[font=\scriptsize, text=gris_fonce_inria, anchor=east] at (-1.08,6) {$2,5$};
                    \node[rotate=90, font=\scriptsize, text=gris_fonce_inria, anchor=south] at (-1.95,2.88) {rayon (m)};
