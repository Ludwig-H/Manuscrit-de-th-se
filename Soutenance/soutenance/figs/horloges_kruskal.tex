...
% Adapté (et francisé) de beamer-presentation-reunion-2026-07-16/hierarchical_sw_frames.tex
                \begin{tikzpicture}[
                    ...
                    \useasboundingbox (-0.45, -1.35) rectangle (19.95, 2.05);
                    ...
                    \node[v] (e) at (5.4,0)     {$e$};
                    \draw[ge] (a)--node[w,sloped] {$0{,}18$} (b);
                    \draw[ge] (b)--node[w,sloped] {$0{,}42$} (c);
                    \draw[ge] (a)--node[w,sloped,below] {$0{,}74$} (c);
                    \draw[ge] (c)--node[w,sloped] {$0{,}67$} (d);
                    \draw[ge] (b)--node[w,sloped] {$0{,}88$} (d);
                    ...
                    \draw[fe] (aa)--node[w,sloped] {$0{,}18$} (bb);
                    \draw[fe] (bb)--node[w,sloped] {$0{,}42$} (cc);
                    \draw[fe] (cc)--node[w,sloped] {$0{,}67$} (dd);
                    \node[font=\scriptsize, text=inria-rouge] at (10.05,-.85) {forêt couvrante minimale ($\xi_e \le 1$)};
                    ...
                    \begin{scope}[shift={(15.15,-0.55)}, x=.72cm, y=2.05cm]
                        ...
                        \node[font=\tiny, anchor=east] at (-.10,.18) {$0{,}18$};
                        \node[font=\tiny, anchor=east] at (.64,.42)  {$0{,}42$};
                        \node[font=\tiny, anchor=east] at (1.52,.67) {$0{,}67$};
