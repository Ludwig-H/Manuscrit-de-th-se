                \begin{tikzpicture}[xscale=1.0, yscale=1.0]
                    \useasboundingbox (-0.3, -1.15) rectangle (13.1, 4.35);
                    ...
                    \begin{scope}[xshift=5.4cm, yshift=0cm]
                        ...
                        \node[etiq, anchor=west, align=left] at (5.80, 0.62) {\textsf{(ii)}\,+\,\textsf{(iii)}};
                        \node[etiq, anchor=west, align=left] at (5.80, 1.88) {\textsf{(i)}\,+\,\textsf{(iii)}};
                        \node[etiq, anchor=west, align=left] at (5.80, 2.85) {\textsf{(i)}\,+\,\textsf{(ii)}};

                        \node[font=\scriptsize, text=gris_fonce_inria, anchor=north] at (2.6, -0.10)
                            {chaque \textbf{coupe} du dendrogramme satisfait deux axiomes sur trois};
                    \end{scope}
                \end{tikzpicture}
