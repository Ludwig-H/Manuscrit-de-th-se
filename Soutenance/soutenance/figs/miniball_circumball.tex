                ...
                \begin{tikzpicture}[xscale=1.0, yscale=1.0]
                    \useasboundingbox (-0.75, -2.55) rectangle (8.05, 2.05);
                    ...
                    \begin{scope}[shift={(0,0)}]
                        ...
                        \draw[-{Latex[length=2.2mm]}, inria-rouge, densely dashed, line width=0.8pt]
                            (1.5,-0.15) -- (1.5,-1.55);
                        \node[font=\scriptsize, text=inria-rouge, anchor=north] at (1.5,-1.62)
                            {centre hors du cadre};

                        \node[leg, text=gris_fonce_inria] at (1.5,-1.95)
                            {boule \textbf{circonscrite} : $R \approx 2{,}3\,D$\\
                             quand le simplexe s'aplatit, $R \to +\infty$};
                    \end{scope}
                    ...
                    \begin{scope}[shift={(4.35,0)}]
                        ...
                        \node[leg, text=gris_fonce_inria] at (1.5,-1.95)
                            {\textbf{miniboule} : $R \le \sqrt{3/8}\;D$\\
                             toujours définie, centre dans $\mathrm{conv}(\sigma)$};
                    \end{scope}

                    \node[font=\scriptsize, text=gris_fonce_inria, anchor=south] at (3.68,1.62)
                        {le \textbf{même} simplexe, presque plat};
                \end{tikzpicture}
