...
\begin{tikzpicture}[scale=0.82, >=latex, font=\scriptsize]
    ...
    \node[right, align=left] at (7.1, 0) {$\beta=0$ : les \textbf{feuilles}\\{\scriptsize un spin à la fois $\Rightarrow$ \textsc{Glauber}}};
    \node[right, align=left] at (7.1, 4.0) {$\beta=1$ : les \textbf{racines}\\{\scriptsize l'amas entier $\Rightarrow$ \textsc{Swendsen}--\textsc{Wang}}};
\end{tikzpicture}
