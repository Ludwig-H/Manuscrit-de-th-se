...
% beta = 1 : Swendsen--Wang ; entre les deux, un bain a quatre etats.
\begin{tikzpicture}[scale=0.82, >=latex, font=\scriptsize]
    ...
    % Coupe intermédiaire : un nœud interne, ni feuille ni racine
    \draw[dashed, thick, gris_fonce_inria] (-0.6, 2.55) -- (7.1, 2.55);
    \node[gris_fonce_inria, right, align=left] at (7.1, 2.55)
        {une coupe \textbf{intermédiaire}\\{\scriptsize bain à quatre états}};
