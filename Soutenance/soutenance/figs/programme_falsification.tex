                \begin{tikzpicture}[xscale=1.0, yscale=1.0]
                    ...
                    \node[porte] (g4) at (7.55, 0.95) {\textbf{hiérarchie}\\[1pt]{\tiny l'arbre bat les contrôles plats}};
                    ...
                    \node[font=\scriptsize, text=gris_fonce_inria] at (5.35, 0.12)
                        {aucune de ces cinq portes n'est franchie à ce jour};
