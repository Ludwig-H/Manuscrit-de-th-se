...
% gras rouge = gelée.
    \begin{tikzpicture}[x=1cm,y=1cm,scale=0.88,every node/.style={scale=0.88}]
      ...
      % ============ triangle répulsif frustré : jamais les deux arêtes =====
      \node[font=\footnotesize,align=center] at (7.5,2.20) {Triangle \textbf{répulsif} (frustré)\\[-1pt] {\scriptsize jamais les deux arêtes}};
