...
\end{Definition}
\Remarque{En anglais, on appelle cette plus petite boule englobante la \emph{miniball} de $\sigma$. La méthode standard pour calculer le rayon $\rho(\sigma)$ ainsi que d'identifier le centre $c_\sigma$ de la boule $B_\sigma$ est l'algorithme de \nom{Welzl} \cite{Welzl1991}.}
