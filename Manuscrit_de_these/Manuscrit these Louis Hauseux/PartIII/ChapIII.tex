...
L'avantage de produire en sortie un graphe (par rapport par exemple à un masque binaire) est que cela en fait un objet éditable, pouvant ainsi servir d'aide à l'annotation
\cite{CharbonnierMoliard2003CheminsMinimauxFissures}.
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{%\textcolor{red}{Retour des axes}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.49\textwidth}
        ...
        {\small Seuil $\tau$}
    \end{minipage}
    \caption{Exemples de courbes de sensibilité sur CrackForest (bleu : \nom{Jaccard} ; vert : \nom{Tversky} ; rouge : \nom{Wasserstein}). Les réponses les plus instables apparaissent lorsque le graphe est trop fragmenté ou au contraire trop dense.%\textcolor{red}{À séparer}
    }
...
\begin{figure}[H]
    ...
    \caption{%\textcolor{red}{Refaire et séparer }
...
%Enfin, les discussions autour des travaux de Pierre \nom{Chesnay} et Frédéric \nom{Jurie} vont précisément dans cette direction : 
