...
\[
    ...
    \bigr\}.
\]
Autrement dit, un point $y \in \mathbb R^p$ appartient à $L_K(r)$ si la boule de centre $y$ et de rayon $r$ contient au moins $K$ points du nuage $\mathcal X$.
...
Nous étudions ensuite la question algorithmique : comment éviter de construire tout le complexe de \v{C}ech ? (tout comme le Single-Linkage ne construit pas de graphe géoémtrique.)
