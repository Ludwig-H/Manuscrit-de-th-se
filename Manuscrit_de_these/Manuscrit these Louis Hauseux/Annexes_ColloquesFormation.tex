...
\ChronoEntree{30 juin--12 juillet 2025}{École d'été}{%
  ...
  courbure pour l'analyse des temps de mélange, ainsi que le phénomène de
  \emph{cutoff} pour les processus de diffusion en grande dimension.
}
...
\ChronoEntree{Mars 2025}{Séminaire}{%
  Présentation au
  \href{https://team.inria.fr/mathnet/seminar/}{séminaire de l'équipe
